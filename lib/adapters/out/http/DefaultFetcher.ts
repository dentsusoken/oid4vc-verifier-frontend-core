...
import type { Fetcher } from '../../../ports/out/http/Fetcher';
import type { GetRequest } from '../../../ports/out/http/GetRequest';
import type { PostRequest } from '../../../ports/out/http/PostRequest';
import type {
  HttpError,
  HttpHeaders,
  HttpRequestBody,
 ...
 * @public
 */
export class DefaultFetcherError extends Error implements HttpError {
  constructor(
...
export class DefaultFetcher implements Fetcher {
   ...
   */
  private readonly defaultOptions: Partial<HttpRequestOptions> = {
   ...
   *
   * @throws {DefaultFetcherError} When network, timeout, or validation errors occur
   *
   * @example
   * ```typescript
   * const userSchema = z.object({ id: z.string(), name: z.string() });
...
/**
 * Factory function to create a DefaultFetcher instance
 *
 * Provides a convenient way to create a DefaultFetcher instance with
 * optional custom configuration.
 *
 * @returns DefaultFetcher instance
 *
 * @example
 * ```typescript
 ...
 * @public
 */
export function createDefaultFetcher(): DefaultFetcher {
  return new DefaultFetcher();
}

/**
 * Convenience function to create a configured Fetcher instance
 *
 * @returns Fetcher instance ready for use
 *
 * @example
 * ```typescript
